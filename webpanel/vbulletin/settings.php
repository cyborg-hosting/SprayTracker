<?php
		...
		// --VBULLETIN SETTINGS-- //
		define("SUPERADMINS", "1") // This is the GroupID of your superadmin/manager/owner group, it allows full access to blocking and unblocking features
		define("ADMINS", "2") // This is the GroupID of your admins, it allows them to block sprays, but not to view blocked ones or unblock them.
